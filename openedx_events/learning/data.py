...
@attr.s(frozen=True)
class ComplexTypesData:
    """Complex Types Data"""
    # Lists
    list_of_dicts = attr.ib(type=List[dict[str, str]], factory=list)
    list_of_lists = attr.ib(type=List[List[int]], factory=list)
    list_of_attrs = attr.ib(type=List[UserData], factory=list)
    # Dictionaries
    dict_of_lists = attr.ib(type=dict[str, List[int]], factory=dict)
    dict_of_dicts = attr.ib(type=dict[str, dict[str, str]], factory=dict)
    dict_of_attrs = attr.ib(type=dict[str, CourseData], factory=dict)
